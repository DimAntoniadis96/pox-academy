        ...
        <div className="flex flex-col xl:flex-row gap-16 xl:gap-20 items-center">
          ...
          >
            ...
            <p className="text-secondary leading-relaxed mb-6 text-lg">
              Το 1943 σε μία από τις ιστορικότερες συνοικίες της Θεσσαλονίκης ιδρύθηκε ο Ποδοσφαιρικός Όμιλος Ξηροκρήνης. Από την ίδρυσή του αποτελούσε αμιγώς ποδοσφαιρικό σωματείο, με κορυφαία στιγμή στην ιστορία του την παρουσία στη Β' Εθνική Κατηγορία τη σεζόν 1964-1965. Μέχρι και σήμερα η ακαδημία μας λειτουργεί με σκοπό την αθλητική και ψυχολογική ανάπτυξη των παιδιών, χτίζοντας χαρακτήρες μέσα στο γήπεδο.
            </p>
